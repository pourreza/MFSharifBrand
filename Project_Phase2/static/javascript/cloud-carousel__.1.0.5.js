...
(function ($) {
    ...
    var Controller = function (container, images, options) {
        ...
        this.controlTimer = 10000; //changed by farnaz
        this.stopped = false;
        //this.imagesLoaded = 0;
        this.container = container;
        this.xRadius = options.xRadius;
        this.yRadius = options.yRadius;
        this.showFrontTextTimer = 10000; //time changed by farnaz
        ...
        $(container).bind('mouseover click', this, function (event) {
            ...
            var text = $(event.target).attr('data-price');
            // If we have moved over a carousel item, then show the price and title text.
            ...
            if (text !== undefined && text !== null) {
                ...
                if (options.bringToFront && event.type == 'click') {
                    ...
                    console.log("famid");//added by farnaz

                    var idx = $(event.target).data('itemIndex');
                    var frontIndex = event.data.frontIndex;
                    console.log("frontIndex: "+frontIndex);//added by farnaz
        ...
        $(container).bind('mouseout', this, function (event) {
            ...
            context.showFrontTextTimer = setTimeout(function () { context.showFrontText(); }, 10000);
        ...
        this.showFrontText = function () {
          ...
          // console.log(this);
           ...
           $(options.priceBox).html("");
            ...
            //console.log($(items[this.frontIndex].image).attr('title')); //added by Farnaz
            //$(options.priceBox).html($(items[this.frontIndex].image).attr('data-price'));
    ...
    $.fn.CloudCarousel = function (options) {
        ...
        this.each(function () {
            ...
            options = $.extend({}, {
                ...
                speed: 0.2,
                mouseWheel: false,
                bringToFront: true, //changed by farnaz
            }, options);
