...
urlpatterns = patterns('',
    ...
    url(r'^submitEditProduct', 'MFSharif.views.submit_edit_product', name='submit_edit_product'),
    ...
    url(r'^editP/(?P<pro_id>\d+)','MFSharif.views.edit_pro', name = 'editp'),
    ...
    url(r'^removeProduct','MFSharif.views.removeProduct',name='removeProduct'),
