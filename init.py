...
def init():
    ...
    pro5, ok = Product.objects.get_or_create(name='انگشتر پاپیون', category=sub3, price=15036500, popular=False, description='انگشتر الماس بسیار شیک برای آنان که پول دارند', image="images/products/3_00.jpg")
    pro6, ok = Product.objects.get_or_create(name=' دستبند برگ زرد', category=sub3, price=638500, popular=False, description='اجازه دهید پاییز همیشه همراهتان باشد', image="images/products/3_1.jpg")
    pro7, ok = Product.objects.get_or_create(name='ستبند فرد و جورجد', category=sub3, price=69000, popular=False, description='برای آنان که قسم خورده‌اند قصد انجام کار خوبی ندارند', image="images/products/3_3.jpg")
    pro8, ok = Product.objects.get_or_create(name='گوشواره‌های مینا کاری شده', category=sub3, price=69000, popular=False, description='بهترین و رنگارنگ‌ترین هدیه برای دوستتان', image="images/products/3_02.jpg")
    pro9, ok = Product.objects.get_or_create(name='گردنبند گردن سوراخ کن', category=sub3, price=70000, popular=False, description='برای آنان که مشکلی با سوراخی گردن خود ندارند', image="images/products/3_6.jpg")
